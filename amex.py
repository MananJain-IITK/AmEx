"""
Amex Campus Challenge - V16 Experiments
=========================================
...
# ----------------------------------------------------------------------
# 4. Candidate V16 variants
# ----------------------------------------------------------------------
variants = {}

# V16a: swap earned-points cost for ACTUAL redeemed-points cost
C_pts_redeemed_based = df['f21'] * 0.007
variants['v16a_redeemed_pts'] = FIXED_TERMS - C_pts_redeemed_based

# V16b: blend earned + redeemed (average of the two liability views)
C_pts_blended = 0.5 * C_pts_earned_based + 0.5 * C_pts_redeemed_based
variants['v16b_blended_pts'] = FIXED_TERMS - C_pts_blended

# V16c: v16a + forward liability discount from unredeemed balance (f4)
C_pts_overhang = df['f4'] * 0.007 * 0.10   # small forward-looking discount, tune this
variants['v16c_redeemed_plus_overhang'] = (FIXED_TERMS - C_pts_redeemed_based
                                            - C_pts_overhang)

# V16d: v16a + f18 as additional creditworthiness revenue term
R_consumer_credit = df['f18'] * 0.0005     # tune this coefficient
variants['v16d_redeemed_plus_f18'] = (FIXED_TERMS - C_pts_redeemed_based
                                       + R_consumer_credit)

# V16e: dining (f10) given its own multiplier bucket instead of lumped 1x
...
variants['v16e_dining_multiplier'] = fixed_terms_dining - C_pts_dining_based
...
print("""
Next step:
Submit v16a (and whichever of v16c/v16d/v16e shows the lowest overlap
...
10 submissions, prioritize v16a first — it's the highest-confidence
...
write_submission('v16a_redeemed_pts', 'submission_v16a_redeemed_pts')
write_submission('v16c_redeemed_plus_overhang', 'submission_v16c_overhang')
write_submission('v16d_redeemed_plus_f18', 'submission_v16d_f18')
write_submission('v16e_dining_multiplier', 'submission_v16e_dining')